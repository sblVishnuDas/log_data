...
def analyze_log_file(log_file_path):
    ...
    for i, line in enumerate(lines):
        ...
        if login_match:
            ...
            current_session = {
                ...
                # Remove field_edit_count since we're using update_count
            }
    ...
    if edit_match and current_session:
        ...
        # Remove the field_edit_count increment since we're using update_count
...
def create_excel_report(all_sessions, all_ocr_data, all_shortcut_data, all_image_record_data, output_path):
    ...
    total_name_ocr_duration = 0
     ...
     # In the sheet3_data creation section, modify the user metrics calculation:
    for user in unique_users:
        ...
        # Calculate user metrics using update_count instead of field_edit_count
        ...
        sheet3_data.append({
            ...
            "Total Field Edits": user_updates,  # Changed to use total updates count
    ...
    sheet3_data.append({
        ...
        "Total Field Edits": total_updates,  # Changed to use total updates count
...
if __name__ == "__main__":
    ...
    output_excel_path = r"C:\Users\18262\Documents\whyME.xlsx"
